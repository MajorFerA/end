<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","backgroundImage":"url(http://codegen.caihongy.cn/20220404/bf06161dcf3e4733a4e6d4de3e7b6f8a.jpg)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px","borderRadius":"10px","left":"565px","background":"#fff","width":"750px","position":"absolute","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"50px 0 30px 0","lineHeight":"44px","fontSize":"36px","color":"#000","textAlign":"center"}'>校园二手物品交易平台注册</p></div>
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='yonghu'" prop="yonghuzhanghao">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='yonghu'" prop="mima">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='yonghu'" prop="yonghuxingming">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='yonghu'" prop="xingbie">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='yonghu'" prop="lianxifangshi">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='yonghu'" prop="touxiang">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='shangjia'" prop="shangjiazhanghao">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='shangjia'" prop="mima">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='shangjia'" prop="mima">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='shangjia'" prop="shangjiamingcheng">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='shangjia'" prop="xingbie">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>性别：</div>
                <el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
                  <el-option
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='shangjia'" prop="lianxidianhua">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 15px"}' v-if="tableName=='shangjia'" prop="touxiang">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>头像：</div>
                <file-upload
					tip="点击上传头像"
					action="file/upload"
			...
			<el-button :style='{"border":"none","cursor":"pointer","padding":"0 10px","margin":"20px auto 5px","outline":"none","color":"#fff","borderRadius":"8px","background":"rgba(0, 0, 0, 1)","display":"block","width":"80%","fontSize":"16px","height":"44px"}' type="primary" @click="submitForm('registerForm')">注册</el-button>
			<el-button :style='{"cursor":"pointer","border":"1px solid rgba(204, 204, 204, 1)","padding":"0 10px","margin":"20px auto 5px","outline":"none","color":"#000","borderRadius":"8px","background":"none","display":"block","width":"80%","fontSize":"16px","height":"44px"}' @click="resetForm('registerForm')">重置</el-button>
